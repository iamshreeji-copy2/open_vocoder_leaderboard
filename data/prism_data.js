...
window.PRISM_DATA = {
  "identity": {
    ...
    "description": "The 🤗 PRISM-V Leaderboard evaluates open-source and pretrained neural vocoders on English across diverse acoustic conditions, generative architectures, and edge deployment profiles.",
    "version": "v1.0.1",
  ...
  "metric_defs": {
    ...
    "Score": {
      ...
      "direction": "↑ higher better",
      "description": "Composite deployment index combining five dimensions: P (Perceptual quality via UTMOS + NISQA), R (Reconstruction fidelity via PESQ + MCD + LSD), I (Intelligibility preservation via STOI + ΔWER), S (Speaker preservation via embedding similarity), M (Model efficiency via RTF + VRAM + Params). Geometric aggregation with hardware feasibility gate under Edge Profiling. Score 100 = ideal across all dimensions; score 1 = hardware-infeasible on this profile."
    }
  },
  "column_groups": {
    "prism": {
