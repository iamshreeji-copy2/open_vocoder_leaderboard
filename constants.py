...
| Version | Date | Notes |
|---|---|---|
| **v1.0** | Current | Initial 15-model evaluation · LJSpeech, LibriTTS, VCTK, Free_ST |
| *v1.1* | — | Planned: additional vocoders (CodecGAN, DAC-based) |
| *v1.2* | — | Planned: additional corpus (CommonVoice accented) |
"""
